...
class ExcelTabRepuestosDetail extends StatelessWidget {
                ...
                Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                        ...
                        columnSpacing: 25,
                        columns:
                        historicoVentasController.getColumnsTableRepuestoDetalle(),
                        rows: historicoVentasController.getRowsTableRepuestoDetalle()),
                  ),
                ),
              ],
            ),
